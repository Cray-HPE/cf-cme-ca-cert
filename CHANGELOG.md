...
- Bump `actions/checkout` from 4 to 7 ([#47](https://github.com/Cray-HPE/cf-cme-ca-cert/pull/47), [#49](https://github.com/Cray-HPE/cf-cme-ca-cert/pull/49), [#50](https://github.com/Cray-HPE/cf-cme-ca-cert/pull/50))
- Bump `stefanzweifel/git-auto-commit-action` from 5 to 7 ([#48](https://github.com/Cray-HPE/cf-cme-ca-cert/pull/48))
